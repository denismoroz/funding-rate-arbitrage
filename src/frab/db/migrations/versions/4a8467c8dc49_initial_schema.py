...
def upgrade() -> None:
    ...
    with op.batch_alter_table('funding_rates', schema=None) as batch_op:
        batch_op.create_index('ix_funding_rates_lookup', ['coin', 'ts_ms'], unique=False)
    ...
    with op.batch_alter_table('positions', schema=None) as batch_op:
        batch_op.create_index('ix_positions_coin_time', ['coin', 'opened_at_ms'], unique=False)
    ...
    with op.batch_alter_table('prices', schema=None) as batch_op:
        batch_op.create_index('ix_prices_lookup', ['coin', 'ts_ms'], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('positions', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_positions_coin_time')
